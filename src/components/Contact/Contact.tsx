...
function Contact() {
    return (
        <>
            <Navbar />
                <section className="h-screen flex flex-col justify-center items-center text-center px-6 overflow-hidden bg-[url(https://images.unsplash.com/photo-1654892968823-ea564870a96f?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]">
