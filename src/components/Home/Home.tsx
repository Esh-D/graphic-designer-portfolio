...
const Home = () => (
  <>
    <Navbar />
      <section className="h-screen flex flex-row justify-center items-center text-center overflow-hidden">
        ...
        <div className="flex flex-col justify-center p-10 gap-2 align-center">
          ...
          <Link to="/graphic-designer-portfolio/portfolio" className="mt-3 mb-5 px-6 py-2 bg-stone-100 rounded-md hover:bg-stone-200 w-1/2">
